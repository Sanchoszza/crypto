...
class HomeViewModel: ObservableObject {
    ...
    private func mapGlobalMarketData(marketDataModel: MarketDataModel?, portfolioCoins: [CoinModel]) -> [StatisticModel] {
        ...
        let marketCap = StatisticModel(title: "Markey Cap", value: data.marketCap, percentageChange: data.marketCapChangePercentage24HUsd)
...
//        }
        ...
        let percentageChange = ((portfolioValue - previuseValue) / previuseValue)
